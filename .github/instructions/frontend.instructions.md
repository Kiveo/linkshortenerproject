...
- Never use raw HTML form controls such as `button`, `input`, `textarea`, or custom page-level UI markup when a shadcn primitive exists. If the pattern is not already in `components/ui`, do not hand-roll a replacement.
